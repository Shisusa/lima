...
$(function()
{
	...
	$('#quick-search-switcher').on('click', function()
	{
	 ...
	 var docs = [
	  { value: 'Abatelenguas ', data: 'material_de_curacion_lista.html' },	
	 { value: 'Abatelenguas madera ', data: 'abate_madera.html' },
	 { value: 'Abatelenguas madera ', data: 'abate_madera.html' },
	 { value: 'Abatelenguas madera premium ', data: 'abate_madera_pre.html' },
	 { value: 'Abatelenguas plastico ', data: 'abate_plastico.html' },
	 { value: 'Abatelenguas plastico infantil ', data: 'abate_plastico_inf.html' },
	 { value: 'Aguja anestesia Quincke ', data: 'agu_anestesia_Q.html' },
	 { value: 'Aguja anestesia Whitacre ', data: 'agu_anestesia_W.html' },
	 { value: 'Aguja vacutainer ', data: 'agu_vacutiner.html' },
	 { value: 'Aguja desechable ', data: 'agu_desechable.html' },	
	 { value: 'Alcohol Etilico 71 ', data: 'alco_eti_71.html' },
	 { value: 'Alcohol Etilico 71.5 ', data: 'alco_eti_715.html' },
	 { value: 'Alcohol en Gel ', data: 'alco_gel.html' },
	 { value: 'Algodon Rollo', data: 'alco_gel.html' },
	 { value: 'Algodon Plisado ', data: 'alco_gel.html' },
	 { value: 'Alcohol Torunda ', data: 'alco_gel.html' },
	 { value: 'Almohadillas de Gel para Dama ', data: 'alco_gel.html' },
	 { value: 'Almohadillas para Caballero ', data: 'alco_gel.html' },
	 { value: 'Almohadillas para Dama ', data: 'almo_dama.html' },
	 { value: 'Almohadillas Alcohol Esteril  ', data: ' almo_alcohol.html' },
	 { value: 'Aplicador con Algodon Esteril ', data: ' aplica_algo_este.html' },
	 { value: 'Aplicador de madera sin algodon', data: ' aplica_made_sin.html' },
	 { value: 'Apositos algisite ', data: 'apo_algisite.html' },
	 { value: 'Apositos Tegaderm ', data: ' apo_tegaderm.html' },
	 { value: 'Apositos gasa Esteril ', data: ' apo_gasa.html' },
	 { value: 'Bolsa de Agua Caliente ', data: ' bolsa_caliente.html' },
	 { value: 'Bolsa de Alimentacion Enteral ', data: ' bolsa_alimentacion.html' },
	 { value: 'Bolsa de Orina Cama', data: ' bolsa_orina.html' },
	 { value: 'Esponja Azufrada', data: ' esponja.html' },
	 { value: 'Esponja de Gasa Esteril ', data: ' esponja_gasa.html' },
	 { value: 'Gasa Esteril', data: ' gasa_esteril.html' },
	 { value: 'Esponja Gasa RX ', data: ' esponja_no_esteril.html' },
	 { value: 'Esponja de gasa', data: ' esponja_gasa.html' },
	 { value: 'Guante Cirujano ', data: ' guante_ciru.html' },
	 { value: 'Guante Emplomado ', data: ' guante_emplo.html' },
	 { value: 'Jeringa Desechable para Tuberculina ', data: 'jeringa_tuber.html' },
	 { value: 'Jeringa Desechable Esteril ', data: ' jeringa_este.html' },
	 { value: 'Riñon ', data: ' riñon.html' },
	 { value: 'Riñon de plastico ', data: ' riñon_plas.html' },
	 { value: 'Cubre bocas ', data: ' cubrebocas.html' },
	 { value: 'Batas ', data: ' batas.html' },
	 { value: 'Toalla Sanitaria Obstétrica', data: ' toalla_sani.html' },
	 { value: 'Toalla Aseo Paciente', data: 'toalla_aseo .html' },
	 { value: 'Venda Vascular Viscopaste', data: ' venda_vascular.html' },
	 { value: 'Algodonero Tapa ', data: ' algodonera_tapa.html' },
	 { value: 'Sacabocado de Keyes ', data: ' sacabocado.html' },
	 { value: 'Sacabocado Desechable', data: ' sacabocado_des.html' },
	 { value: 'Tijeras Iris', data: ' tijeras_iris.html' },
	 { value: 'Tijeras Iris con Carburo de Tugsteno ', data: ' tijeras_carburo.html' },
